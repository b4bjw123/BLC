...
function loadSaved(){
    ...
    // locationData.querySelector("input[name=altitudeTO]:checked") = form2.altitudeTOUnit;
    // locationData.querySelector("input[name=altitudeMax]:checked") = form2.altitudeMaxUnit;
    calcTotalKG()
    calcLift()
